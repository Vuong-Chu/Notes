...
\textit{Definition 2.1:} If $A$ and $B$ are nonempty sets, then the Cartesian product $AxB$ of $A$ and $B$ is the set of all ordered pairs $(a,b)$ with $a \in A$ and $b \in B$. That is,
\begin{equation*}
A x B := \{(a,b): a \in A, b \in B\}
\end{equation*}
\textit{Definition 2.2:} Let $A$ and $B$ be sets. Then, a function from $A$ to $B$ is a set $f$ of ordered pairs in $A x B$ such that for each $a \in A$ there exists a unique $b \in B$ with $(a,b) \in f$.\\
\textit{Definition 2.3:} If $E$ is a subset of $A$, then direct image of $E$ under $f$ is the subset $f(E)$ of $B$ given by
\begin{equation*}
f(E) := \{f(x) : x \in E\}
\end{equation*}
...
\end{equation*}
\textit{Definition 2.4:} Let $f : A \rightarrow B$ be a function from $A$ to $B$:\\
...
\textit{Definition 2.5:} If $A \rightarrow B$ is a bijection of A onto B, then
\begin{equation*}
...
\textit{Definition 2.6:} Cantor's Theorem: If $A$ is any set, then there is no surjection of $A$ onto the set $P(A)$ of all subsets of $A$.
